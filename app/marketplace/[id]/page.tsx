    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
        ...
        >
          ...
          <span>/</span>
          <span className="text-gray-800 whitespace-nowrap truncate max-w-[150px] sm:max-w-none">
            {productData.name}
          </span>
        </motion.div>
          ...
          <div>
            ...
            {activeTab === "reviews" && (
              <div className="space-y-6">
                ...
                {productData.reviews && productData.reviews.length > 0 ? (
                  <div className="space-y-4">
                    {productData.reviews.map((review) => (
                      <Card key={review.id} className="p-4 sm:p-6 bg-white/80 backdrop-blur-md border border-gray-200">
                              ...
                              <div className="flex">
                                {[...Array(5)].map((_, i) => (
                                  <span
                                    key={i}
                                    className={`text-sm ${
                                      i < (review.count_rate || 0) ? "text-yellow-500" : "text-gray-300"
                                    }`}
                                  >
                                    ★
                                  </span>
                  ...
                  <Card className="p-6 text-center bg-white/80 backdrop-blur-md border border-gray-200">
                ...
                {/* Review Form */}
                {user && (
                  <Card className="p-4 sm:p-6 bg-white/80 backdrop-blur-md border border-gray-200 mt-6">
                    ...
                    {!userCanReview ? (
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <textarea
                            className="w-full p-3 border border-gray-300 rounded-lg bg-white focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm sm:text-base"
                            rows={4}
